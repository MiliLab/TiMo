...
class ConvModule(nn.Module):
    ...
    def __init__(self, in_channels, channels, kernel_size, padding=0, 
                 conv_cfg=None, norm_cfg=None, act_cfg=None, inplace=None):
        super(ConvModule, self).__init__()

        self.conv = nn.Conv2d(in_channels, channels, kernel_size, stride=1, padding=padding)
...
class BaseDecodeHead(BaseModule, metaclass=ABCMeta):
    ...
    def _stack_batch_gt(self, batch_data_sample) :
        gt_semantic_segs = [
